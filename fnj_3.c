...
int main(int argc, char *argv[])
{
   ...
   printf("FNJ_SEQ_%d_%1.4f\n",size,f);
//   printf("Tam Matriz t=%d Tam. Heap = %d",t, limite);
...
//        printf("Juntando Pares de OTU's\n");
        ...
        for(int c=0; c<limite; c++) {
           ...
           if (size > 2) {
             ...
             //else
             //   printf("ALOCOU************\n");
             //if(strlen(aux)>strlen(otus[menor].name)){
             //  printf("ERRORRR %ld %ld\n", strlen(aux), strlen(aux)+y);
             // return 0;
             //}
